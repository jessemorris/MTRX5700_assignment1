...
class MoveGroupPythonInteface(object):
    ...
    def __init__(self):
        ...
        # set some collision parameters
        # self.scene.allowed_collision_matrix.entry_names=["block_1", "block_2", "block_3", "block_4", "block_5"]
        # self.scene.allowed_collision_matrix.entry_values=[True, True, False, False, False]
    ...
    def open_gripper(self, object_to_detach=None):
        ...
        Opens the gripper
        """
        self.gripper.open_gripper(object_to_detach)

    def close_gripper(self, object_to_attach=None):
        """
        Closes the gripper
        """
        self.gripper.close_gripper(object_to_attach)
    ...
    def move_blocks_by_magic(self, pos_x, pos_y):
        """
        ...
        for i in range(5):
            ...
            try:
                ...
                print("Service call failed: %s" % e)
        print("Block and goal position randomized")
